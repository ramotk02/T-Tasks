...
export default function DefaultSidebar() {
  ...
  return (
    <Card className={`w-full max-w-[15rem] p-10 shadow-xl shadow-blue-gray-900/10 dark:bg-[#31353E] ${sidebarCollapsed ? 'max-w-[4rem] p-' : ''}`}>
      <div className="mb-5 p-9 text-xl flex"> {/* Centrage des emojis */}
      ...
      <List className={`space-y-[300px] ${sidebarCollapsed ? 'justify-center' : ''} ${sidebarCollapsed ? 'text-center' : ''}`}> {/* Centrage des icônes */}
        ...
        <ListItem>
          <ListItemPrefix>
            ...
            <button onClick={toggleSidebar}>
              <ChevronLeftIcon className="h-5 w-5 mx-3" title="Toggle Sidebar" />
            </button>
          </ListItemPrefix>
        </ListItem>
      </List>
